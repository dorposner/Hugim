...
def main():
    ...
    if ready:
        if st.session_state["allocation_run"]:
            ...
            if st.button("Run Allocation"):
                ...
                mapped_hugim = hugim_df[[hugim_mapping["HugName"], hugim_mapping["Capacity"], hugim_mapping["Minimum"]] + list(hugim_mapping["Periods"])]
                ...
                try:
                    ...
                    try:
                        ...
                        fig = px.bar(chart_df, x='Assignment Type', y='Count', text='Percent', title="Assignments by Preference Rank", color='Assignment Type')
                    ...
                    if ready and 'missing_hugim' in locals() and missing_hugim:
                        ...
                        for hug in missing_hugim:
                            ...
                            for period, prefix in prefs_mapping.get("PeriodPrefixes", {}).items():
                                ...
                                campers_wanted.extend([f"{str(camper)} (Period: {period})" for camper in wanted_these])
    ...
    st.markdown("---")
    st.markdown("Built By Dor Posner with ❤️ for Camp Administrators | [Support](mailto:dor.posner@gmail.com))")
